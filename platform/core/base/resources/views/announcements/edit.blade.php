        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="3" name="description" class="form-control">{{ old('description', $announcement->description) }}</textarea>
                        </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check mb-2">
                            <input type="checkbox" class="form-check-input" name="status" value="1" {{ $announcement->status ? 'checked' : '' }}>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-media-picker name="image" :value="old('image', $announcement->image)" />
                    </div>
                </div>
